...
type t = {
  ...
  state_root_hash_state: State_root_hash_state.t
};
...
let make =
  ...
  };
  {
    ...
    state_root_hash_state: {
      pending_hashes: State_root_hash_set.empty,
      done_hashes:
        State_root_hash_set.singleton(Block.genesis.state_root_hash),
    },
  };
};
